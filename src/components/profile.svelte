...
<div class="navigationTabs mt-12 flex justify-center gap-4">
	<a href="https://github.com/bbbayhan" target="_blank"
		><svg
			width="24"
			height="24"
			...
			viewBox="0 0 24 24"
			role="img"
			class="size-6 fill-current text-[color:#94a3b8] transition-transform duration-200 hover:scale-125"
		...
		></a
	>
	<a href="https://www.linkedin.com/in/beste-burcu-bayhan/" target="_blank"
		><svg
			width="24"
			height="24"
			xmlns="http://www.w3.org/2000/svg"
